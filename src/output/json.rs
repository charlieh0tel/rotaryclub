...
impl Formatter for JsonFormatter {
    fn format(&self, output: &BearingOutput) -> String {
        ...
        format!(
            r#"{{"ts":"{}","bearing":{:.1},"raw":{:.1},"confidence":{:.2},"snr_db":{:.1},"bearing_uncertainty_deg":{},"signal_strength":{:.2},"signal_present":{},"resultant_length":{:.3},"tone_peak":{:.4},"lock_quality":{},"phase_error_variance":{}}}"#,
            iso8601_timestamp(),
            output.bearing,
            output.raw,
            output.confidence,
